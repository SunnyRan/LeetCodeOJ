...
public class RecoverCADState {
  ...
  public static void main(String[] args) throws Exception {
    ...
    gui.List<Class<? extends generics.Shape>> shapeTypes =
      (gui.List<Class<? extends generics.Shape>>)in.readObject();
    Line.deserializeStaticState(in);
    gui.List<generics.Shape> shapes = (List<generics.Shape>)in.readObject();
