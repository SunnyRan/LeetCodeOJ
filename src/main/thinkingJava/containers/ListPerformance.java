...
public class ListPerformance {
  ...
  static class ListTester extends concurrency.Tester<List<Integer>> {
  ...
  public static void main(String[] args) {
    if(args.length > 0)
      concurrency.Tester.defaultParams = TestParam.array(args);
    // Can only do these two tests on an array:
    concurrency.Tester<List<Integer>> arrayTest =
      new concurrency.Tester<List<Integer>>(null, tests.subList(1, 3)){
    ...
    arrayTest.timedTest();
    concurrency.Tester.defaultParams= TestParam.array(
    ...
    concurrency.Tester.fieldWidth = 12;
    concurrency.Tester<LinkedList<Integer>> qTest =
